...
class MainWindow(QMainWindow):
    ...
    @Slot(str, QMetaType.LongLong) # Use QMetaType.LongLong for large file sizes
    ...
    @Slot(str, QMetaType.LongLong, QMetaType.LongLong) # Use QMetaType.LongLong for large file sizes
